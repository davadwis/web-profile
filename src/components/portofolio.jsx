...
const Portofolio = () => {
  ...
  return (
    <>
      <div id="portofolio" className="md:pt-44 pt-28">
        ...
        <div className="grid-cols-1 sm:grid md:grid-cols-2 w-11/12 md:pb-48 md:w-5/6 m-auto content-center gap-4 mt-4 p-4">
          {listPortofolio.map((item) => (
            <div key={item.name}>
              <div
                className="mt-4 flex flex-col self-start rounded-lg bg-white shadow-primary/50 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] border-gray-900 sm:shrink-0 sm:grow sm:basis-0 md:h-[760px]"
                data-aos="flip-left"
