    ...
    return(
        ...
        <div id="contact" className="text-center pt-36">
            ...
            <div className="grid-cols-1 sm:grid md:grid-cols-3 mb-64 p-4 w-11/12 m-auto content-center">
                ...
                <div className="mx-3 mt-6 flex flex-col self-start rounded-lg bg-white shadow-primary/50 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] border-gray-900 sm:shrink-0 sm:grow sm:basis-0">
